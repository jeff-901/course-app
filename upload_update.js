...
db.once("open", () => {
  console.log("open");
  glob("F:/109-1/Web Programming/tmp/*.csv", function (err, files) {
        ...
        .on("data", async (row) => {
          ...
          if (data.length === 1) {
            await Course.updateOne(
              ...
              {
                commonRequired: row.commonRequired,
                otherCourse: row.otherCourse,
              ...
              (err) => {
                if (err) {
                  console.log(err);
                  console.log("update error", row.courseName);
                } else {
                  console.log("success");
                }
              }
            ...
            await Course.insertMany(course, (err) => {
              if (err) {
                console.log(err);
                console.log(row.courseName);
                console.log("create error", row.courseName);
              } else {
                console.log("success");
              }
            });
